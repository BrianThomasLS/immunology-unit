/*:
* @plugindesc​ (2023/01/20) Automatically pauses dialogue at punctuation marks.
* @author mjshi
*
...
Window_Base.prototype.convertEscapeCharacters = function(text) {
	...
	if (switchID === 0 || !$gameSwitches.value(switchID)) {
		...
		text = text.replace(/([.?!~void 0,-:、：])" /g, "$&\\\lsoff\\.\\.\\lson ");
		text = text.replace(/([.?!~void 0,-:、：])' /g, "$&\\\lsoff\\.\\.\\lson ");
		text = text.replace(/([.?!~void 0,-:、：])\) /g, "$&\\\lsoff\\.\\.\\lson ");
		text = text.replace(/- /g, "-\\. ");
		text = text.replace(/, /g, ",\\. ");
		...
		text = text.replace(/：/g, "：\\.");
		text = text.replace(/: /g, ":\\. ");
		text = text.replace(/\? /g, "?\\\lsoff\\.\\.\\lson ");
		text = text.replace(/! /g, "!\\\lsoff\\.\\.\\lson ");
		text = text.replace(/; /g, ";\\\lsoff\\.\\.\\lson ");
		text = text.replace(/~ /g, "~\\\lsoff\\.\\.\\lson ");
